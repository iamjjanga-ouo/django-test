...
# SECRET_KEY = 'q-g_n!c)m_0dxji24@(3)fo=(qekp17m68pcif*xjfdl&q0wr_'
SECRET_KEY = os.environ.get('DJANGO_SECRET_KEY', 'q-g_n!c)m_0dxji24@(3)fo=(qekp17m68pcif*xjfdl&q0wr_')
